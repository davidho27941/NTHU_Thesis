...
\input{Part/TitlePage} %封面和書名頁
\input{Part/Abstract} %中英文摘要
\input{Part/Acknowledgments} %致謝
\input{Part/Contents} %目錄和圖表
\input{Part/Introduction} 
\input{Part/TheTopPhysicsandMachineLearning.tex}
\input{Part/EventGeneration.tex}
\input{Part/EventReconstruction.tex}
