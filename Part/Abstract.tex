...
The top quarks produced by proton-proton collisions in the Large Hadron Collider(LHC) undergo a very complicated process of formation. To date, the decay product of top quarks are still not well-classified. In this project, we present a novel approach to the ``all hadronic decay'' process of top quarks based on the neural networks with attention mechanism, we we refer to as the ``Symmetry Preserving Attention Networks''(SPA-Net). These networks identify the decay products of each quark unambiguously and without combinatorial explosion. This approach performs outstandingly compared to the generally accepted state-of-the-are method. Our networks can correctly assign all hadronic decay in 93.0\% of 6 jets, 87.8\% of 7 jets, and 82.6\% of $ \geq 8$ jets event respectively.
